tinymce.PluginManager.add('lana_icon', function (editor) {

    editor.addButton('lana_icon', {
        tooltip: 'Icon Shortcode',
        icon: 'lana-icon',
        cmd: 'lanaIconShortcodeCmd'
    });

    editor.addCommand('lanaIconShortcodeCmd', function () {
        editor.windowManager.open({
            ...
            onsubmit: function (e) {
                editor.focus();
                editor.execCommand('mceInsertContent', false, '[lana_icon name="' + e.data.name + '"]');
            }
        });
    });
});
